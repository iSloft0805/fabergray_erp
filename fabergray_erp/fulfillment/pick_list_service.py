...
def create_pick_list_for_available_stock(sales_order):
    ...
    List mapper (`create_pick_list()`, the exact function behind the
    standard "Create Pick List" button and already used by this app's own
    test fixtures) -- not a hand-built Pick List document.
    ...
    pick_list = create_pick_list(so_name)
